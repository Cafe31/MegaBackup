...
def upload_file(credentials, target_path, backup_path, backup_name):
	...
	try:
		resp_headers = conn.head_object(credentials['container'], backup_path + backup_name + "moi")
		print('The object ' + backup_name + ' was successfully uploaded in ' + credentials['container'] + backup_path)
